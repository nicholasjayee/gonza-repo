...
import { CarriageInwardFormData } from "@/inventory/hooks/useCarriageInwards";
import { useCashAccounts } from "@/inventory/hooks/useCashAccounts";
              ...
              <PopoverTrigger asChild>
                <Button
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
                      e.preventDefault();
                      const cashAccountSelect = document.querySelector(
