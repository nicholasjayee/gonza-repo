...
import { Product, ProductCategory, ProductFormData } from "@/inventory/types/";
...
import { Calendar as CalendarComponent } from "@/inventory/components/ui/calendar";
...
const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const { uploadProductImage, compressImage } = useProductImage();
              ...
              <div className="grid gap-3">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      router.push(
                        `/categories?returnTo=${encodeURIComponent(window.location.pathname)}`,
                      )
                    }
                    disabled={isSubmitting}
                  >
