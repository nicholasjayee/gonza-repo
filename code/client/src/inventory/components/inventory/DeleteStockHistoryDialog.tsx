    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description:
            "The stock history entry has been deleted and stock recalculated.",
        });
        onOpenChange(false);
      } else {
        toast({
          title: "Delete failed",
          description:
            "Failed to delete stock history entry. Please try again.",
          variant: "destructive",
        });
      }
    } catch (error) {
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-3">
              <p>
                This stock history entry was created by a sales operation and
              ...
              <div className="bg-blue-50 border border-blue-200 p-3 rounded-lg">
                <div className="text-blue-800 text-sm">
                  <strong>Note:</strong> To remove this entry, please edit or
                  delete the corresponding sale in the Sales section.
                </div>
              </div>
            </AlertDialogDescription>
          </AlertDialogHeader>
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="space-y-3">
            <p>
              Are you sure you want to delete this stock history entry? This
            ...
            <div className="bg-muted p-3 rounded-lg space-y-2">
              ...
              <div className="text-sm space-y-1">
                ...
                >
                  <strong>Impact:</strong> {stockChange >= 0 ? "+" : ""}
                  {stockChange} units
                </div>
                <div>
                  <strong>Reason:</strong>{" "}
            ...
            <div className="bg-amber-50 border border-amber-200 p-3 rounded-lg">
              <div className="text-amber-800 text-sm">
                <strong>Warning:</strong> After deletion, the product&apos;s
                current stock will be automatically recalculated based on the
                remaining stock history entries.
              </div>
            </div>
          </AlertDialogDescription>
        </AlertDialogHeader>
