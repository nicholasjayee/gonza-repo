      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="space-y-2">
            <p>
              Are you sure you want to delete all stock entries for this
              invoice?
            </p>
            <div className="bg-muted p-3 rounded-lg">
              ...
              <p>
                <strong>Items:</strong> {group.entries.length} products will be
                affected
              </p>
            </div>
            <p className="text-destructive text-sm">
              This will permanently remove all stock history entries for this
              purchase and recalculate stock levels. This action cannot be
              undone.
            </p>
          </AlertDialogDescription>
        </AlertDialogHeader>
