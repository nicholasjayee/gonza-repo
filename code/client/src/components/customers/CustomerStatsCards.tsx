...
const CustomerStatsCards: React.FC<CustomerStatsCardsProps> = ({ customerStats }) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
      <Card className="bg-linear-to-br from-blue-50 to-blue-100 border-blue-200 hover:shadow-md transition-shadow">
      ...
      <Card className="bg-linear-to-br from-green-50 to-green-100 border-green-200 hover:shadow-md transition-shadow">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
      ...
      <Card className="bg-linear-to-br from-purple-50 to-purple-100 border-purple-200 hover:shadow-md transition-shadow">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
