            ...
            <div className="space-y-3">
              {paginatedCustomers.map((customer, idx) => {
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="shrink-0">
                      <div className={`
                        ...
                        ${index === 0 ? 'bg-linear-to-br from-amber-400 to-amber-600 text-white shadow-lg' : 
                          index === 1 ? 'bg-linear-to-br from-gray-300 to-gray-500 text-white shadow-md' :
                          index === 2 ? 'bg-linear-to-br from-amber-600 to-amber-800 text-white shadow-md' :
                          'bg-linear-to-br from-blue-50 to-blue-100 text-blue-700 border border-blue-200'}
                      `}>
                        {index + 1}
                      </div>
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-start justify-between gap-2">
                          <h4 className="font-semibold text-gray-900 text-sm sm:text-base leading-tight wrap-break-word flex-1">
                            {customer.name}
                          </h4>
                          {/* Position Badge */}
                          <div className="shrink-0">
                            {index === 0 && (
                              <Badge className="bg-linear-to-r from-amber-500 to-amber-600 text-white border-0 text-xs font-semibold px-2 py-1 shadow-md">
                                👑
                              </Badge>
                            )}
                            {index === 1 && (
                              <Badge variant="secondary" className="bg-linear-to-r from-gray-400 to-gray-500 text-white border-0 text-xs font-semibold px-2 py-1">
                                🥈
                              </Badge>
                            )}
                            {index === 2 && (
                              <Badge variant="secondary" className="bg-linear-to-r from-amber-700 to-amber-800 text-white border-0 text-xs font-semibold px-2 py-1">
                                🥉
                              </Badge>
                            )}
                            {index > 2 && (
                  ...
                  <div className="absolute inset-0 bg-linear-to-r from-blue-500/0 to-purple-500/0 group-hover:from-blue-500/5 group-hover:to-purple-500/5 rounded-xl transition-all duration-200 pointer-events-none" />
                </div>
                );
              })}
                      {/* Pagination Controls */}
