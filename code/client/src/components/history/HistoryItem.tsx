    ...
    <div className="space-y-3 p-2 md:p-3 bg-muted rounded">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 pb-2 border-b border-border">
        ...
        <div>
          ...
          <p className="text-sm font-semibold">UGX {metadata.totalAmount?.toLocaleString() || '0'}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-sm">UGX {metadata.profit?.toLocaleString() || '0'}</p>
        </div>
      </div>
                ...
                <div className="space-y-1">
                  ...
                  {item.discountPercentage > 0 && (
                    <p className="text-xs text-orange-600">
                      Discount: {item.discountPercentage}% (UGX {item.discountAmount?.toLocaleString()})
                    </p>
                  )}
                </div>
              </div>
        ...
        <div className="pt-2 border-t border-border">
          <div className="grid grid-cols-1 xs:grid-cols-2 gap-2 text-xs">
            <div>
              ...
              <span className="ml-1 font-medium">UGX {metadata.amountPaid?.toLocaleString() || '0'}</span>
            </div>
            {metadata.taxRate > 0 && (
              <div>
