...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/inventory/components/ui/card';
import { PieChart, Pie, Cell, Legend, ResponsiveContainer, Tooltip } from 'recharts';
import { Button } from '@/inventory/components/ui/button';
import { Input } from '@/inventory/components/ui/input';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/inventory/components/ui/table';
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle } from '@/inventory/components/ui/alert-dialog';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/inventory/components/ui/select';
import { Calendar } from '@/inventory/components/ui/calendar';
import { Popover, PopoverContent, PopoverTrigger } from '@/inventory/components/ui/popover';
import { Sale } from '@/sales/types';
import { useSalesCategories } from '@/sales/hooks/useSalesCategories';
          ...
          {categoryPerformance.length > 0 ? isMobile ? <div className="space-y-3">
                ...
                <TableBody>
                  {categoryPerformance.map((category, index) => <TableRow key={category.name}>
                      ...
                      <TableCell className="text-right font-mono">{formatCurrency(category.profit)}</TableCell>
