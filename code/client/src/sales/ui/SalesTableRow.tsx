...
import { TableRow, TableCell } from '@/inventory/components/ui/table';
...
import { useCashTransactions } from '@/sales/hooks/useCashTransactions';
import { useIsMobile } from '@/sales/hooks/use-mobile';
