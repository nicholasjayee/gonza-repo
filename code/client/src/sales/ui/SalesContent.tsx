...
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/inventory/components/ui/tabs';
...
import { useDeletedSales } from '@/sales/hooks/useDeletedSales';
...
export const SalesContent: React.FC = () => {
  ...
  // const { userId } = useCurrentUser(); // Removed or use stub if needed
  const userId = currentBusiness?.adminId; // Approximating user ID from business or context
