...
// BLOCKED: CarriageInward model missing in Prisma schema.
export const useCarriageInwards = () => {
  return {
    carriageInwards: [],
    isLoading: false,
    createCarriageInward: async () => null,
    updateCarriageInward: async () => false,
    deleteCarriageInward: async () => false,
    refreshCarriageInwards: async () => {}
  };
};
