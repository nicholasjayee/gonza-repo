...
import { Filter, X, Calendar, Database, Tag } from 'lucide-react';
        ...
        <div className="bg-muted/30 border border-border rounded-2xl p-6 mt-4 mb-8 space-y-6">
            <div className="flex items-center justify-between border-b border-border/50 pb-4">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold">Advanced Search Filters</h3>
                </div>
                <button
                    onClick={onClear}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="space-y-3">
                    <div className="flex items-center gap-2 px-1">
                        ...
                        <span className={labelClasses.replace("mb-1.5", "")}>Stock Range</span>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                        <input
                            type="number"
                ...
                <div className="space-y-3">
                    <div className="flex items-center gap-2 px-1">
                        ...
                        <span className={labelClasses.replace("mb-1.5", "")}>Timeline</span>
                    </div>
                ...
                <div className="space-y-3">
                    <div className="flex items-center gap-2 px-1">
                        ...
                        <span className={labelClasses.replace("mb-1.5", "")}>Entity</span>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                        <select
                            name="categoryId"
