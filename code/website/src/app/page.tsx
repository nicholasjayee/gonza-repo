...
const Nav = () => (
  <nav className="fixed top-0 z-50 flex w-full items-center justify-between px-6 py-4 backdrop-blur-xl border-b border-border/40 bg-background/60">
    ...
    <div className="flex items-center gap-4">
      <a href="http://localhost:3001" className="text-xs font-bold uppercase tracking-widest hover:text-primary transition-colors">Sign In</a>
      <a href="http://localhost:3002" className="rounded-xl bg-primary px-6 py-2.5 text-xs font-black uppercase tracking-widest text-white shadow-xl shadow-primary/20 hover:scale-105 transition-all active:scale-95">Get Started</a>
    </div>
  </nav>
);
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <div className="flex flex-col gap-4 text-sm font-medium text-muted-foreground">
            <a href="http://localhost:3002" className="hover:text-primary transition-colors">Client Portal</a>
            <a href="http://localhost:3003" className="hover:text-primary transition-colors">Admin Terminal</a>
            <a href="http://localhost:3001" className="hover:text-primary transition-colors">Authentication</a>
          </div>
        </div>
        <div>
      ...
      <main className="flex-1">
        ...
        <section className="relative px-6 pt-40 pb-24 md:pt-56 md:pb-40 lg:pt-64 lg:pb-56 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <a href="http://localhost:3002" className="h-16 flex items-center justify-center rounded-2xl bg-primary px-10 text-xs font-black uppercase tracking-[0.2em] text-white shadow-2xl shadow-primary/30 hover:scale-110 hover:shadow-primary/40 transition-all active:scale-95">
              Launch Dashboard
            </a>
            <a href="http://localhost:3003" className="h-16 flex items-center justify-center rounded-2xl border border-border bg-background/50 backdrop-blur-sm px-10 text-xs font-black uppercase tracking-[0.2em] text-foreground hover:bg-secondary transition-all">
              Kernel Access
            </a>
          </div>
        ...
        <section className="px-6 py-40">
          <div className="max-w-6xl mx-auto rounded-[3rem] bg-background border border-border p-12 md:p-24 text-center relative overflow-hidden shadow-3xl">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <a href="http://localhost:3002" className="h-16 flex items-center justify-center rounded-2xl bg-foreground text-background px-10 text-xs font-black uppercase tracking-[0.2em] transform hover:scale-105 transition-all active:scale-95 shadow-2xl">
                Deploy System
              </a>
            </div>
          </div>
