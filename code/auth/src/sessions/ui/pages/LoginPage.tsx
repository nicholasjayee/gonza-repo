        ...
        <div className="relative min-h-screen w-full flex items-center justify-center p-6 bg-background overflow-hidden">
            ...
            <div className="w-full max-w-md animate-fade-in group">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <p className="text-muted-foreground mt-2 text-center text-sm">Enter your credentials to access your dashboard</p>
                </div>
                    ...
                    <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center px-1">
                                ...
                                <a href="/forgot-password" className="text-xs font-medium text-primary hover:underline">Forgot?</a>
                            </div>
                ...
                <p className="mt-8 text-center text-sm text-muted-foreground">
                    Don't have an account? <a href="/signup" className="font-bold text-primary hover:underline ml-1">Sign up now</a>
                </p>
            </div>
        </div>
    );
