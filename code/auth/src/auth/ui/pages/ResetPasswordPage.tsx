...
export default function ResetPasswordPage() {
    return (
        <div className="flex min-h-screen w-full bg-background font-sans">
            ...
            <AuthBanner
                title="Identity is the new"
                highlight="perimeter security."
                description="Complete your password reset to regain access to your enterprise dashboard. Always use a strong, unique password."
            />
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 lg:p-16 text-left">
                <div className="w-full max-w-[400px]">
                    ...
                    <div className="mb-8 lg:mb-10 text-left">
                        <h2 className="text-2xl lg:text-3xl font-bold tracking-tight text-foreground">Set New Password</h2>
